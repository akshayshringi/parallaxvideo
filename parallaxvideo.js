...
var overlayHeight = $('.content-overlay').height();
var overlayOffsetHeight = $('.getoffset').offset().top;
var overlaybottomoffsetheight = $('.getbottomoffset').offset().top;
    ...
    Plugin.prototype = {
        ...
        playPauseVideo: function () {
            ...
            this.options.$window.on('scroll.backgroundVideoPlayPause', function () {
                var overlayTopHeight = (me.options.$window.height()) + (me.options.$window.scrollTop());
                var overlayBottomHeight = (((overlayHeight)*3)/4) + (overlayOffsetHeight);
                if(overlayTopHeight >= (overlayOffsetHeight+(100)) && me.options.$window.scrollTop() <= (overlaybottomoffsetheight)-(100)) {
